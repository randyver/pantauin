    ...
    <div className="relative w-full overflow-hidden">
      ...
      <div className="relative lg:absolute left-1/2 lg:-translate-x-1/2 mt-12 lg:mt-0 lg:bottom-[-220px] w-full max-w-[1441px] flex flex-col lg:flex-row justify-center items-center gap-24 lg:gap-8 px-6 lg:px-10 z-20">
        ...
        {[
          ...
          { icon: <LayoutDashboard size={44} />, title: "Social Signal Dashboard", desc: "Visualisasi mention, sentimen publik, dan trending keyword secara real-time." },
          { icon: <MapIcon size={44} />, title: "Risk Map Indonesia", desc: "Peta interaktif dengan indikator hijau-kuning-merah per wilayah & hotspot." },
          { icon: <ShieldAlert size={44} />, title: "Incident Explorer", desc: "Daftar laporan dari sosmed, berita, & user bisa difilter & ditelusuri detailnya." }
        ].map((card, idx) => (

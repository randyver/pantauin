  ...
  return (
    <div className="space-y-4 md:space-y-6 animate-in fade-in duration-700">
      ...
      <div className="glass p-3 md:p-4 rounded-2xl flex flex-wrap items-center gap-2 md:gap-4 border-white/40 shadow-sm">
        ...
        <button className="flex items-center gap-2 px-3 md:px-4 py-2 bg-white/50 border border-border/50 rounded-xl text-xs md:text-sm font-semibold hover:bg-white transition-all hidden sm:flex">
          ...
          <table className="w-full text-left min-w-[560px]">
            <thead>
              <tr className="bg-primary/5 text-[10px] font-bold text-muted-foreground uppercase tracking-widest border-b border-border/50">
                ...
                <th className="px-4 md:px-6 py-3 md:py-4 hidden sm:table-cell">Lokasi</th>
            ...
            <tbody className="divide-y divide-border/50">
              {recentIncidents.map((incident) => (
                ...
                >
                  ...
                  <td className="px-4 md:px-6 py-3 md:py-4 text-xs md:text-sm font-medium text-foreground hidden sm:table-cell">
        ...
        {selectedIncident && (
          <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center sm:p-6">
            ...
            <motion.div
              ...
              className="relative w-full sm:max-w-2xl bg-white sm:rounded-3xl shadow-2xl overflow-hidden max-h-[92dvh] flex flex-col"

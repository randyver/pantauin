...
export default function IncidentExplorerPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-700">
      {/* Filters */}
      <div className="glass p-4 rounded-2xl flex flex-wrap items-center gap-4 border-white/40 shadow-sm">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-white/50 border border-border/50 rounded-xl text-sm font-semibold hover:bg-white transition-all">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-foreground text-white rounded-xl text-sm font-semibold hover:bg-black transition-all">
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-primary/5 text-[10px] font-bold text-muted-foreground uppercase tracking-widest border-b border-border/50">
                <th className="px-6 py-4">Status & Judul</th>
      ...
      <AnimatePresence>
        {selectedIncident && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
            ...
            >
              <div className="h-48 bg-primary relative p-8">
                <button 
                  onClick={() => setSelectedIncident(null)}
                ...
                <div className="mt-8">
                  ...
                  <h2 className="text-2xl font-bold text-white mt-3">{selectedIncident.title}</h2>
              ...
              <div className="p-8 grid grid-cols-3 gap-6">
                <div className="col-span-2 space-y-8">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      ...
                      Tim investigasi lapangan telah dikerahkan untuk melakukan verifikasi di SD {selectedIncident.location}.
                    </p>
                  </div>

                  <div>
                    <h3 className="text-sm font-bold text-foreground mb-4 flex items-center gap-2">
                      <History className="w-4 h-4 text-primary" /> Lini Masa Investigasi
                    </h3>
                ...
                <div className="space-y-6">
                  <div className="p-4 bg-primary/5 rounded-2xl border border-primary/10">
                    <p className="text-[10px] font-bold text-muted-foreground uppercase mb-3 tracking-widest">Metadata</p>
                  ...
                  <button className="w-full py-3 bg-foreground text-white rounded-xl text-xs font-bold flex items-center justify-center gap-2 hover:bg-black transition-all">
                    Eskalasi Tugas <MessageSquare className="w-4 h-4" />
                  </button>
                </div>
              </div>
            </motion.div>
